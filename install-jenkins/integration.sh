...
sudo cat ~/install-jenkins/data/config.xml | sudo java -jar jenkins-cli.jar -s http://localhost:8080 create-job php-breakfast-box-job  --username "$J_USERNAME" --password "$J_PASSWORD"
